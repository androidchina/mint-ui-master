<template>
  <div>
    ...
    <div class="praise_list" v-if="show_auditing_person">
      <img class="img_praise" src="../../assets/img/auditing_person.png"  alt=""/>审核人：{{report_detail_json.reportDetail.verify_member_names}}
    </div>
  ...
  export default {
    ...
    data () {
      return {
        ...
        show_auditing_person: false, // 是否显示审批人
        ...
        report_id:''
      }
    },
    mounted: function () {
      this.getReportList();
    ...
    methods: {
      ...
      // 发送评论
      sendComment() {
        if (this.comment_send == null || Object.keys(this.comment_send).length == 0) {
          Toast("请输入评论内容");
        } else {
          this.axios({
            method:'post',
